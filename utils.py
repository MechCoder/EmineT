...
def build_phonemes_vocab():
    data_path = "data/single_phonemes/train"
    list_of_files = os.listdir(data_path)
    phonemes = []

    for file_ in list_of_files:
        curr_lines = open(os.path.join(data_path, file_), "r").readlines()
...
def gen_audio_phonemes_pairs(batch_size=32, step_length=0.0125, num_steps=40,
                             random_state=None, path="train", return_phonemes=False,
                             return_y=False, step_shift=0):
    """
    ...
    phoneme_to_id = build_phonemes_vocab()
...
def gen_audio_phonemes_pairs2(batch_size=32, step_length=0.0125, num_steps=40,
                              random_state=None, path="train", return_phonemes=False,
                              return_y=False):
    """
    Audio raw-amplitude batch generator.
