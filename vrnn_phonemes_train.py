...
def train(train_dir, lyr_dir, valid_dir=None, lyr_valid_dir=None,
    ...
    vae = build_vrnn(lstm_size=lstm_size, num_steps=num_steps, z_dim=z_dim,
                     ...
                     step_shift=step_shift, use_phonemes=True)
    ...
    train_gen = audio_amplitudes_gen(
        ...
        wav_dim=wav_dim, step_shift=step_shift, lyr_dir=lyr_dir)
    ...
    if valid_dir is not None:
        valid_gen = audio_amplitudes_gen(
            ...
            wav_dim=wav_dim, step_shift=step_shift, lyr_dir=lyr_valid_dir)
...
if __name__ == "__main__":
    ...
    train(train_dir=args.train_dir, lyr_dir=args.lyr_dir, valid_dir=args.valid_dir,
